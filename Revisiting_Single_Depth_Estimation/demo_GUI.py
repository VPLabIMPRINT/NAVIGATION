...
def main():
    ...
    file_name = []
    count = 0
    for file in os.listdir("/content/drive/My Drive/PyTorch-YOLOv3/data/custom/images/"):
    # for file in os.listdir("/content/drive/My Drive/semantic-segmentation-pytorch/data/ADEChallengeData2016/images/validation/"):
        ...
        file_names.append("/content/drive/My Drive/PyTorch-YOLOv3/data/custom/images/"+file)
...
def test(nyu2_loader, model,x,h,w):
    ...
    for i, img in enumerate(nyu2_loader):     
        ...
        matplotlib.image.imsave("/content/drive/My Drive/PyTorch-YOLOv3/data/custom/labels/"+x, stretch_near)
        # print(end_time)
        count += 1
