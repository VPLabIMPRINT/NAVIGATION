...
def custom_collate(batch):
    ...
    return data, targets
    ### code added from link : https://github.com/andy-yun/pytorch-0.4-yolov3/issues/65
...
class listDataset(Dataset):
    def __init__(self, root, shape=None, shuffle=True, crop=True, jitter=0.3, hue=0.1, saturation=1.5, exposure=1.5, transform=None, target_transform=None, train=False, seen=0, batch_size=64, num_workers=4):
